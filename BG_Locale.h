...
//***********************************************************
const char PAGE_Main_BG[] PROGMEM = "<!DOCTYPE html>\
<html>\
<head>\
<meta lang='en' http-equiv='Content-Type' content='text/html' charset='UTF-8'>\
<title>MiniWX Метео станция</title>\
<style>\
...
function getData() {\
  ...
  <body>\
    <hr>\
    <h3 style='text-shadow: 2px 1px grey;'>{{callsign}} Метео Станция - <a id='clock' class='tabheader' style='padding-right:10px'>{{time}}</a></h3>\
    ...
    <div class='divTable'>\
      <div class='divRow'>\
        <div class='divColumn' style='width:{{fieldsize1}}'>\
          <div class='tabheader'>Параметър</div>\
        ...
        <div class='divColumn' style='width:{{fieldsize2}}'>\
          <div class='tabheader'>Стойност</div>\
    ...
    <legend style='text-shadow: 2px 1px grey;'> Системна информация </legend>\
      <div class='divTable'>\
          <div class='divRow'>\
            <div class='divColumn' style='width:{{fieldsize5}}'>\
              <div class='tabheader'>Онлайн</div>\
              <div class='tabheader'>Следващ TX</div>\
              <div class='tabheader'>SSID</div>\
              <div class='tabheader'>RSSI</div>\
              <div class='tabheader'>BSSID</div>\
              <div class='tabheader'>IP адрес</div>\
              <div class='tabheader'>Позиция</div>\
            </div>\
    ...
    <form action='/submit' method='POST'>\
      ...
      <legend style='text-shadow: 2px 1px grey;'> Контролен панел </legend>\
    ...
    <p>MiniWX Station&#8482; ({{SOFT_VER}}) - цъкнете <a href='https://github.com/sq2mo/MiniWXStation'>тук</a> и проверете за последна версия</p>\
  </body>\
</html>";
...
//***********************************************************
const char PAGE_MiniWXSettings_BG[] PROGMEM = "<!DOCTYPE html>\
<html>\
<head>\
<meta  lang='en' http-equiv='Content-Type' content='text/html; charset=UTF-8'>\
<title>MiniWX Настройки</title>\
</head>\
<style>\
...
<body>\
  ...
  <hr>\
    <h1><a style='text-shadow: 2px 1px grey;'>MiniWX Станция&#8482; Settings</a></h1>\
    <form style='width:58%' action='/submit' method='POST'>\
        <div class='divTable'>\
          <div class='divRow'>\
            <div class='divColumn' style='width:99%'>\
              <fieldset>\
              <legend><h2> Инициал на станцията и позиция </h2></legend>\
        ...
        <div class='divTable'>\
          <div class='divRow'>\
            <div class='divColumn'>\
              <fieldset>\
              <legend><h2>APRS Настройки</h2></legend>\
            ...
            <div class='divColumn'>\
              <fieldset>\
              <legend><h2>Статични IP настройки</h2></legend>\
                <span>\
                  ...
                  <label>Използвай статичен IP (трябва рестарт)</label>\
                </span><p></p>\
                <label>IP</label>\
          ...
          <div class='divRow'>\
            <div class='divColumn'>\
              <fieldset>\
              <legend><h2>WUNDER Настройки</h2></legend>\
                <div>\
                  <span>\
                    ...
                    <label>Изпращане на пакет до WUNDER</label>\
                  </span>\
                </div>\
                <p></p>\
            ...
            <div class='divColumn'>\
              <fieldset>\
              <legend><h2>NTP Настройки</h2></legend>\
                <label>Server</label>\
        ...
        <div id='footer' style='padding-left:18px'><p>MiniWX Станция&#8482; ({{SOFT_VER}}) - цъкнете <a href='https://github.com/sq2mo/MiniWXStation'>тук</a> и проверете за последна версия</p></div>\
    </form>\
  </div>\
</body>\
</html>";
